  ...
  return (
    <Router>
      {/* <nav>
        <ul>
          <li>
            <a href="/daily-production">Daily Production Reports</a>
          </li>
          <li>
            <a href="/monthly-production">Monthly Production Reports</a>
          </li>
          <li>
            <a href="/total-order">Total Order Reports</a>
          </li>
          <li>
            <a href="/employee-database">Employee Database Reports</a>
          </li>
          <li>
            <a href="/employee-attendance">Employee Attendance Reports</a>
          </li>
        </ul>
      </nav> */}
      <Routes>
        ...
        <Route
          path="/sample-follow-ups/:id"
          element={<SampleFollowUpDetail />}
        />
        ...
        <Route
          path="/inquiries/confirmed"
          element={<InquiryList status="confirmed" />}
        />
        <Route
          path="/inquiries/pending"
          element={<InquiryList status="pending" />}
        />
